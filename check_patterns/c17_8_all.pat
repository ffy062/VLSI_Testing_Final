...
#number of test vectors = 54
#total number of gate faults (uncollapsed) = 34
#total number of detected faults = 28
#total gate fault coverage = 82.35%
#number of equivalent gate faults (collapsed) = 34
#number of equivalent detected faults = 28
#equivalent gate fault coverage = 82.35%
